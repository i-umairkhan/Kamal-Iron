...
def entry():
    ...
    def CalcTotal():
        total1 = Label(entryPage,text= int(float(rate1.get()) * float(Weight1.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total1.place(x=460,y=175)

        total2 = Label(entryPage,text= int(float(rate2.get()) * float(Weight2.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total2.place(x=460,y=227)

        total3 = Label(entryPage,text= int(float(rate3.get()) * float(Weight3.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total3.place(x=460,y=279)

        total4 = Label(entryPage,text= int(float(rate4.get()) * float(Weight4.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total4.place(x=460,y=331)

        total5 = Label(entryPage,text= int(float(rate5.get()) * float(Weight5.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total5.place(x=460,y=383)

        total6 = Label(entryPage,text= int(float(rate6.get()) * float(Weight6.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total6.place(x=460,y=435)

        total7 = Label(entryPage,text= int(float(rate7.get()) * float(Weight7.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total7.place(x=460,y=487)

        total8 = Label(entryPage,text= int(float(rate8.get()) * float(Weight8.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
    ...
    def searchfun():
        ...
        for i in range(len(df)):
            if(df.loc[i,"Name"]==name.get()):
                ...
                break
        global nouser
        nouser = Label(recivingPage,text= "NO RECORD FOUND TRY AGAIN",background="#FF0000",font="height=20")
        if(df.loc[i,"Name"]!=name.get()):
            CustomerName = " "
...
def returning():
    ...
    def CalcTotal():
        searchfun()
        total1 = Label(returnPage,text= int(float(rate1.get()) * float(Weight1.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total1.place(x=460,y=175)

        total2 = Label(returnPage,text= int(float(rate2.get()) * float(Weight2.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total2.place(x=460,y=227)

        total3 = Label(returnPage,text= int(float(rate3.get()) * float(Weight3.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total3.place(x=460,y=279)

        total4 = Label(returnPage,text= int(float(rate4.get()) * float(Weight4.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total4.place(x=460,y=331)

        total5 = Label(returnPage,text= int(float(rate5.get()) * float(Weight5.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total5.place(x=460,y=383)

        total6 = Label(returnPage,text= int(float(rate6.get()) * float(Weight6.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total6.place(x=460,y=435)

        total7 = Label(returnPage,text= int(float(rate7.get()) * float(Weight7.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total7.place(x=460,y=487)

        total8 = Label(returnPage,text= int(float(rate8.get()) * float(Weight8.get()) ),padx=10,pady=3,background="#C4C4C4",font="height=20")
        total8.place(x=460,y=537)
...
def mill():
    ...
    # *** CLEAR BUTTON ****************************************
    clear = Button(millPage,text="Clear",command=clearfun,padx=20,pady=5,background="#47B759",fg="#ffffff",width=10)
    clear.place(x=289,y=428)
    # *********************************************************

    # *** CLEAR BUTTON ****************************************
    clear = Button(millPage,text="Clear",command=clearfunMill,padx=20,pady=5,background="#47B759",fg="#ffffff",width=10)
    ...
    # *** SEARCH BUTTON ***************************************
    transferAmount = Button(millPage,text="Transfer",command=transfer,padx=20,pady=5,background="#473459",fg="#ffffff",width=10)
    transferAmount.place(x=460,y=486)
    # *********************************************************
